        ...
        public static void main(String[] args) {
            ...
            do{
                ...
                if(userInput == 'N' | userInput == 'S' | userInput == 'E' | userInput == 'W'){
                    ...
                    System.out.println("\nPlease enter the one the directions listed at the bottom of the board.");
                }
            }while (exit_code = true);
        }

        // Create routine to check if there are any goblins in the array
        // if yes return false
        // if no return true to signal completion of game.
